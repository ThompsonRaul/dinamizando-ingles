...
import imgURL from "../../utils/images/24-2/UECT.png";

const imgAlt = "Horários de aula do UESC English 2024.2";
...
const UE = () => {
  return (
    <>
      <Head>
        <title>UESC English 2024.2</title>
        <meta
          name="description"
          content="Página do UESC English 2024.2 do Dinamizando"
        />
